...
Gemessene Inhaltshöhen: 1797 px ab 700 px Breite, 2432 px bei 500 px, rund 2550 px auf dem
...
<iframe id="tankrechner-einfach"
  ...
  style="width:0; min-width:100%; border:none; display:block;"></iframe>
<script src="https://cdn.jsdelivr.net/npm/iframe-resizer@4.3.9/js/iframeResizer.min.js"></script>
<script>iFrameResize({ checkOrigin: false, heightCalculationMethod: 'lowestElement' }, '#tankrechner-einfach');</script>
```
