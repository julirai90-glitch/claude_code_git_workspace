...
const NODES = {{
  ...
  q3:{{type:'yn',step:3,q:'Sind Sie mit der heutigen Zusammensetzung des Landrates rundum zufrieden?',
    yes:'r_unch',no:'q5',crumbY:'Zufrieden',crumbN:'Will Veränderung'}},
  q5:{{type:'radio',step:4,q:'Welche Veränderung ist Ihnen besonders wichtig?',
    opts:[
      ...
      {{l:'Im Landrat soll es mehr Frauen haben.',next:'q7',crumb:'Mehr Frauen'}},
      {{l:'Im Landrat soll es mehr Junge haben.',next:'q7',crumb:'Mehr Junge'}},
      {{l:'Im Landrat soll es mehr Landwirte, Gewerbebetreibende, Rechtsanwälte, Lehrer usw. haben.',next:'q7',crumb:'Mehr Vielfalt'}},
