    ...
    chartVariants: [
      {
        ...
        series: [
          ...
          {label:'Italienischsprachig',color:'#B5001E',points:[
            {name:'Brusio',x:49.7,y:6,pop:1099},{name:'Grono',x:44.7,y:5,pop:1580},
      ...
      },
      {
        ...
        series: [
          ...
          {label:'Rätoromanisch',color:'#16803A',names:['Pontresina','Samedan','Silvaplana','Zuoz','Scuol','Bregaglia','Avers','Zernez','Surses','Bever','Bergün Filisur','Muntogna da Schons','Rheinwald','Obersaxen Mundaun','Valsot','Trun','Sufers','Tujetsch','Schluein','Falera','S-chanf','Medel (Lucmagn)','Lumnezia','La Punt Chamues-ch','Sumvitg','Madulain','Safiental','Trin','Sagogn','Val Müstair']},
          {label:'Italienischsprachig',color:'#B5001E',names:['Brusio','Grono','Poschiavo','San Vittore','Calanca','Roveredo (GR)','Mesocco','Castaneda','Lostallo','Soazza','Cama','Rossa','Buseno','Santa Maria in Calanca']},
